        ...
        return(
            <div class="mt-5 pt-5 pb-5 footer">
                ...
                <div class="row">
                    ...
                    <h2>About Us</h2>
                    <p class="pr-5 text-white-50">Kami memberikan akses untuk para siswa mendapatkan soal - soal latihan dalam meningkatkan kompetensinya masing - masing.</p>
                    </div>
                    ...
                    <div class="col-lg-4 col-xs-12 location">
                        ...
                        <p><i class="fa fa-envelope-o mr-3"></i>info@easy.com</p>
                    </div>
