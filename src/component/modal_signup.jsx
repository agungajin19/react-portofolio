...
class ModalSignUp extends React.Component{
    render(){
        return(
            // <!-- Modal -->
            <div className="modal fade" id="modalSignUp" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content" style={{backgroundColor:'#ffe8d5'}}>
                        <div className="modal-header text-center" style={{backgroundColor:'#ff8364'}}>
                            <h5 className="modal-title mx-auto" style={{color:'#ffe8d5'}}>DAFTAR</h5>
