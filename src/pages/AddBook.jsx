        ...
        return(
            ...
            <form onSubmit={e=> e.preventDefault(e)}>
                <div className="form-group row">
                    ...
                    <input type="text" name='judulAdd' onChange={e=>this.handleInputAddBook(e)} className="form-control" id="inputPassword3" required/>
                    </div>
                </div>
                <div className="form-group row">
                    <label for="inputEmail3" className="col-sm-4 col-form-label">Subjek</label>
                    <div className="col-sm-8">
                    <input type="text" name='matapelajaranAdd' onChange={e=>this.handleInputAddBook(e)} className="form-control" id="inputEmail3" required/>
                    </div>
                </div>
                <div className="form-group row">
                    <label for="inputPassword3" className="col-sm-4 col-form-label">Jumlah Soal</label>
                    <div className="col-sm-8">
                    <input type="text" name='jumlah_soalAdd' onChange={e=>this.handleInputAddBook(e)} className="form-control" id="inputPassword3" required/>
                    </div>
                </div>
                <div className="form-group row">
                    <label for="inlineFormCustomSelect" className="col-sm-4 col-form-label">Jenjang</label>
                    <div className='col-sm-8 '>
                        <select class="custom-select " id="inlineFormCustomSelect" name='jenjangAdd' onChange={e=>this.handleInputAddBook(e)}>
                ...
                <div className="form-group row">
                    <label for="inlineFormCustomSelect" className="col-sm-4 col-form-label">Jenjang</label>
                    <div className='col-sm-8 '>
                        <select class="custom-select " id="inlineFormCustomSelect" name='kelasAdd' onChange={e=>this.handleInputAddBook(e)}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-8">
                    <input type="text" name='url_pictureAdd' onChange={e=>this.handleInputAddBook(e)} className="form-control" id="inputPassword3" required/>
                    </div>
                </div>
                <div className="form-group row">
                    <label for="inputPassword3" className="col-sm-4 col-form-label">Harga</label>
                    <div className="col-sm-8">
                    <input type="text" name='hargaAdd' onChange={e=>this.handleInputAddBook(e)} className="form-control" id="inputPassword3" required/>
                    </div>
                </div>
                <div className="form-group row">
...
export default connect('judulAdd, hargaAdd, matapelajaranAdd, jumlah_soalAdd, jenjangAdd, kelasAdd, url_pictureAdd, deskripsiAdd, statusPenerbit', actions
)(withRouter(AddBook))